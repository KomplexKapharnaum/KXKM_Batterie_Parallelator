...
// Allocateur global pour la cross-compile xtensa-esp32s3-none-elf : wrapper
// GlobalAlloc qui FFI-appelle heap_caps_malloc / heap_caps_free d'ESP-IDF
// (Phase 12 — remplace le bump allocator Part 1).
