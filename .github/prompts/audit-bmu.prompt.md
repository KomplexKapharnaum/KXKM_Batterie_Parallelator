...
argument-hint: "Portée de l'audit (ex: src/WebServerHandler.cpp, src/main.cpp)"
agent: "agent"
---

Réalise un audit ciblé BMU sur la portée suivante: ${input:Portée de l'audit (fichiers/dossiers ou 'src/**')}.
